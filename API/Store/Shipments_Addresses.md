...
## Intro
Manages Shipments Addresses
## Endpoints
The below endpoints are available with this API

| Endpoint | Method | Description | |
| --- | --- | --- | --- |
| /shipments/:shipment/addresses/ | POST | This allows you to add addresses to a shipment | [Details](#create-shipment-addresses) |
| /shipments/:shipment/addresses/:address | DELETE | This allows you to delete a shipment address | [Details](#delete-shipment-address) |
| /shipments/:shipment/addresses/ | GET | This allows you to list the addresses belonging to a shipment | [Details](#view-shipment-addresses) |
| /shipments/:shipment/addresses/:address/ | GET | This allows you to list the addresses belonging to a shipment | [Details](#view-shipment-addresses) |

## Create Shipment Addresses
This allows you to add addresses to a shipment
