...
| status | The status of the variant | String | One of the following values: `active`, `discontinued`, `hidden` | active | N | N |
...
| status | The status of the variant | String | One of the following values: `active`, `discontinued`, `hidden` |
