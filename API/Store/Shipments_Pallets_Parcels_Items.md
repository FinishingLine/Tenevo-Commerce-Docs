...
| --- | --- | --- | --- |
| /shipments/:shipment/pallets/:pallet/parcels/:item/items/ | POST | This allows you to add items to a shipment pallet parcel | [Details](#create-shipment-pallets-parcels-items) |
...
**URL** : `/shipments/:shipment/pallets/:pallet/parcels/:item/items/`
