...
| offline_message | An offline message to show when the store is restricted | String | Up to 200 characters long |
...
| status | The status of the store | String | One of the following values: `active`, `restricted` |
